...
# ========== BorderFactory ==========
SEARCH_RADIUS = 10  # acts as proxy for water level, lower  values leads to higher water
MIN_NUM_IN_CLUSTER = 5  # eliminates noise


# ========== mapGenerator ==========
DIRECTORY_NAME_TILES = "/var/www/html/tiles/"
FILE_NAME_REGION_NAMES = "top_categories.tsv"
