...
//function to check if any other utfgrid layers currently exist and if so, remove them (helper function for handleUTFGRID)
function clearUTFLayers(){
	if(map.hasLayer(utfgrid0)){
		map.removeLayer(utfgrid0);
	}
	if(map.hasLayer(utfgrid1)){
		map.removeLayer(utfgrid1);
	}
	if(map.hasLayer(utfgrid2)){
		map.removeLayer(utfgrid2);
	}
	if(map.hasLayer(utfgrid3)){
		map.removeLayer(utfgrid3);
	}
	if(map.hasLayer(utfgrid4)){
		map.removeLayer(utfgrid4);
	}
	if(map.hasLayer(utfgrid5)){
		map.removeLayer(utfgrid5);
	}
	if(map.hasLayer(utfgrid6)){
		map.removeLayer(utfgrid6);
	}
	if(map.hasLayer(utfgrid6)){
		map.removeLayer(utfgrid6);
	}
	if(map.hasLayer(utfgrid7)){
		map.removeLayer(utfgrid7);
	}
	if(map.hasLayer(utfgrid8)){
		map.removeLayer(utfgrid8);
	}
	if(map.hasLayer(utfgrid9)){
		map.removeLayer(utfgrid9);
	}
	if(map.hasLayer(utfgrid10)){
		map.removeLayer(utfgrid10);
	}
	if(map.hasLayer(utfgrid11)){
		map.removeLayer(utfgrid11);
	}
	if(map.hasLayer(utfgrid12)){
		map.removeLayer(utfgrid12);
	}
	if(map.hasLayer(utfgrid13)){
		map.removeLayer(utfgrid13);
	}
	if(map.hasLayer(utfgrid14)){
		map.removeLayer(utfgrid14);
	}
	if(map.hasLayer(utfgrid15)){
		map.removeLayer(utfgrid15);
	}
	if(map.hasLayer(utfgrid16)){
		map.removeLayer(utfgrid16);
	}
