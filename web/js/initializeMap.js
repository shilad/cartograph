    ...
    currentLayer.on('click', function(e) {
		if(e.data){
			...
			//NOTE: could make this much simpler in the future by using JQuery and 'append' - to look into 
		  	page_info_box.innerHTML = '<div class = "centered"><style>#explanation {padding-top: 20px}</style> <h4 id="explanation"> Article Name: </h4><h3><strong> ' + e.data.citylabel + '</strong> </h3> <p> Visit <a href = "'+ url + '" target = "_blank"> Wikipedia Page </a></p> </div>';
		} else {
