...
class AddMapService:
    ...
    def on_post(self, req, resp):
        ...
        map_config, map_config_path = self.gen_config(map_id)
        bad_articles, data_columns = self.gen_data(map_config, input_file)
