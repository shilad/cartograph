...
class BorderBuilder:
    ...
    def _initialize(self, config):
        featureDict = Util.read_features(config.getSample("PreprocessingFiles", "coordinates_with_water"),
                                         config.getSample("PreprocessingFiles", "clusters_with_water"),
                                         config.getSample("PreprocessingFiles", "denoised_with_id"))
